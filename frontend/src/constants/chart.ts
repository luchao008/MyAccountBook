...
// ⚠️ FL-1 §4.5：顺序按「闭环相邻」口径重排 —— 把「青」与「翠绿」换位。
//    原因：环形图是闭环，首段与末段在 12 点方向也相邻，但旧校验只比对了
//    i 与 i+1，从未比对 (n-1, 0)。「其他」永远排末位，所以这一对稳定可达。
//    重排后最小相邻可区分度 74.98 → 90.15（阈值 70）。
export const CHART_SERIES = [
  '#c2410c', // 1 品牌橙红
  '#1d63b8', // 2 蓝
  '#c2185b', // 3 品红
  '#0e7490', // 4 青（原第 6 位，前移）
  '#7c3aed', // 5 紫
  '#0e7c42', // 6 翠绿（原第 4 位，后移）
  '#8a94a6', // 7 中性灰（「其他」专用）
] as const;
